  ...
  return (
    <>
      <section className=" mt-[10.6875rem] text-center">
        <div className="container">
          ...
          <p className="mx-auto mt-5 mb-[1.5625rem] max-w-[46.875rem] text-lg">
            As an aviation business player, we are committed to the highest
            standards of service ensuring we have all the right processes and
            systems in place. We not only meet aviation standards, we exceed
            them.
            <br />
            Carthage Sky acheived ISO9001, ISO14001 & OHSAS 18001 certifications
            in February 2019.
          </p>
      ...
      <section className="container text-center">
        <h2 className="mb-12 text-3xl font-bold lg:text-5xl">
          Our Accreditations
        </h2>
        <div className="flex flex-wrap justify-center gap-8 md:justify-between">
          <div className="">
            ...
            <div className="border border-black">
              <Image
                src="/imgs/choose-us/accreditations/quality.webp"
                alt="quality"
                width={321}
                height={448}
              />
        ...
        <RowCard
          className="mt-[6.125rem] md:mt-[8.125rem] lg:mt-[12.125rem]"
          image="/imgs/choose-us/card1.webp"
        >
          ...
          <p className="text-lg md:mb-6">
            These accreditations applaud us for meeting international standards
            and demonstrating that we are able to provide highest level of
            service quality, Environment , safety and security to customers.
            They honor our dedication to prevent pollution and preserve
            environement for future generations, as well as our commitment
            regarding safety and security in all activities.
            <br />
            <br />
            Our certification was issued on the 13thFebruary 2019 and is valid
            until 12thFebruary 2022. All audits were performed by TUV Intercert
            Germany.
          </p>
          <Link href="#">
            <a className="text-lg text-primary-400 transition-all hover:text-primary-400/90">
              Code of Conduct
            </a>
          </Link>
        </RowCard>
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(-90deg, rgba(70, 186, 235, 0) 0%, rgba(70, 186, 235, 0.918) 100%)",
            zIndex: 1,
          }}
        />
        ...
        >
          ...
          <p className="mt-6 max-w-[35rem] text-lg">
            ...
            management structures which enable an integrated vision and agile
            decision making process.
          </p>
        </div>
        <Image
          src="/imgs/choose-us/cloud2.webp"
          alt=""
      ...
      <section id="company-governance" className="container">
