...
const AboutUsPage = () => {
  return (
    <>
      <section className=" mt-[10.6875rem] text-center">
        <div className="container">
          ...
          <p className="mx-auto mt-5 mb-[1.5625rem] max-w-[46.875rem] text-lg">
            Established in 2014 and Headquartered in Tunis , Carthage Sky is evolving from an airline representative
            into what is now a worldwide Flight Support provider for a full suite of aviation services as well as Air
            Operations Supervisor, FBO, OCC and Executive Lounge facilities.
          </p>
        </div>
        <div className="f-ai-c relative mt-[3.2313rem] h-[25rem] w-full justify-center md:h-[34.5625rem]">
          ...
          <div className="translate-x-20">
            <Parallax translateX={["0px", "-30px"]} speed={-1}>
              <Image src="/imgs/about-us/plane.webp" alt="sky" width={959} height={404} />
            </Parallax>
          </div>
        </div>
      </section>
      ...
      {/* Banner */}
      <div
        className={` relative isolate mb-[4.75rem] mt-[7.625rem] flex h-[32rem] w-full  items-center justify-center rounded-xl py-[2.1875rem] text-start text-white md:py-[6.3125rem] lg:h-[36.625rem]`}
      >
        <div
        ...
        >
          ...
          <CustomSwiper>
            ...
            <SwiperSlide>
              <p className="mt-6 text-lg">
                Initiatives and management structures which enable an integrated vision and agile decision making
                process.
              </p>
            </SwiperSlide>
            <SwiperSlide>
        ...
        <Image src="/imgs/services-page/bg.webp" alt="" name="services-banner" layout="fill" />
      ...
      <section className="container md:mt-[10.125rem]">
        <RowCard className="" image="/imgs/choose-us/card1.webp">
          ...
          <p className="text-lg md:mb-6">
            Thanks to the confidence of our partners landing from commercial airlines, private operators, airport
            authorities, business leaders, heads of state, government agencies all the way to non-governmental
            organizations, we have been able to build an international network of partner covering many aspects of
            aviation services.
          </p>
        </RowCard>
        <RowCard className="mt-[4.25rem] flex-row-reverse md:mt-[5.5625rem]" image="/imgs/about-us/card2.webp">
          <h3 className="mt-1 mb-3 text-2xl font-bold leading-snug md:mb-6 lg:text-[2.125rem]">Our Team</h3>
          <p className="text-lg md:mb-6">
            Our team has a mix of very experienced menbers and younger talented members who bring a fresh look and new
            ideas, opening the network you need to access a global, specialized services from a single reliable source.
            <br />
            <br />
            Our lean operation structure allows us to focus on each client’s individual needs, tailoring our services to
