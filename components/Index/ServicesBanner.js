...
const ServicesBanner = ({ className }) => {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(72,190,238,1) 0%, rgba(86,196,240,1) 39%, rgba(184,236,255,1) 100%)",
      }}
    >
      ...
      <p className="mt-6 mb-8 max-w-[56rem] text-lg">
        Satisfying your needs is our biggest priority. We offer a wide variety
        of services to make your journey effortless.
      </p>
